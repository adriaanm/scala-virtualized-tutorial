...
trait SQLExps extends CoreExps {
  ...
  case class Table[Tuple <: Result](name: String)(implicit val loc: SourceLocation) extends Exp[List[Tuple]]
...
object Test extends App  {
  object Example extends EmbedSQL with SQLCodeGen {
    ...
    def prog = {
      ...
      items.Select(e => new Result { val customerName = e.customerName; val address = e.address })
    }
  }
